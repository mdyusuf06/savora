    ...
    <div className="min-h-screen bg-savora-cream text-savora-navy font-body">
      ...
      <section className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl mx-auto animate-fade-up">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/menu">
              <Button className="bg-white text-savora-navy hover:bg-white/90 text-lg px-8 py-6 rounded-full w-full sm:w-auto transition-transform hover:scale-105">
                View Menu
              </Button>
            </Link>
            <Link to="/contact">
              <Button variant="outline" className="border-2 border-white text-white hover:bg-white hover:text-savora-navy text-lg px-8 py-6 rounded-full w-full sm:w-auto backdrop-blur-sm transition-all hover:scale-105">
                Visit Us
              </Button>
            </Link>
          </div>
      ...
      <section className="py-24 bg-savora-navy text-white text-center px-4 relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-3xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link to="/contact">
              <Button className="bg-white text-savora-navy hover:bg-white/90 text-lg px-10 py-6 rounded-full w-full sm:w-auto">
                Get Directions
              </Button>
            </Link>
            <Link to="/menu">
              <Button variant="outline" className="border-white text-white hover:bg-white/10 hover:text-white text-lg px-10 py-6 rounded-full w-full sm:w-auto">
                Browse Menu
              </Button>
            </Link>
          </div>
